...
class ChatsControllerTest < ActionController::TestCase
  ...
  test "should create chat" do
    assert_difference('Chat.count') do
      post :create, chat: { communication_id: @chat.communication_id, user_id: @chat.user_id }
    end
  ...
  test "should update chat" do
    patch :update, id: @chat, chat: { communication_id: @chat.communication_id, user_id: @chat.user_id }
    assert_redirected_to chat_path(assigns(:chat))
  end
