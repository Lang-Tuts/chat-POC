...
class CommunicationsControllerTest < ActionController::TestCase
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post :create, communication: { broadcast_id: @communication.broadcast_id, receiver_id: @communication.receiver_id, sender_id: @communication.sender_id }
    end
  ...
  test "should update communication" do
    patch :update, id: @communication, communication: { broadcast_id: @communication.broadcast_id, receiver_id: @communication.receiver_id, sender_id: @communication.sender_id }
    assert_redirected_to communication_path(assigns(:communication))
  end
